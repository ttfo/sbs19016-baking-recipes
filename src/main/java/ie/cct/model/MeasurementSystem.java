...
public interface MeasurementSystem {
	...
	enum measurmentLocalSystem { uscs , metric; }; // can be metric or United States customary system (USCS), ref. https://en.wikipedia.org/wiki/United_States_customary_units
	enum measurementType { volume , weight; }; // can be volume or weight
